...
import com.esprit.microservice.service.CarReservationService;

@RestController
@RequestMapping(value = "/api/CarReservation")
public class CarReservationController {

	@Autowired
	CarReservationService service;


	@PostMapping
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<CarReservation> createCarReservation(@RequestBody CarReservation reservation) {

		return new ResponseEntity<>(service.addCarReservation(reservation), HttpStatus.OK);
	}
	...
	@PutMapping("/{id}")
	@ResponseStatus(HttpStatus.OK)
	public CarReservation updateCarReservation(@PathVariable(value = "id") int id, @RequestBody CarReservation reservation) {
